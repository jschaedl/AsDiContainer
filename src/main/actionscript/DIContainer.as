	...
	public class DIContainer
	{
		...
		private function checkDependencyPresence(dependencyIdentifier:String):void
		{
			if (container[dependencyIdentifier] != null)
				throw new DependencyAlreadyExistError(
					StringUtil.substitute("Dependency {identifier} already exists!", dependencyIdentifier));
		}
		...
		private function checkDependencyExistence(dependencyIdentifier:String):void
		{
			if (container[dependencyIdentifier] == null)
				throw new DependencyNotFoundError(
					StringUtil.substitute("Dependency {identifier} not found!", dependencyIdentifier));
		}
	}
}